...
- when trading activity is highest
- whether the data pipeline can handle 10,000 records
- whether the data is clean enough for analytics

You will build the project in three stages:

1. Team 1 downloads the market data.
2. Team 2 cleans the messy data.
3. Team 3 analyzes the cleaned data with Spark.

Start with [Team 1: Data Collection](02_Team1_Data_Collection.md).
